...
**Romance.exe** is a charming web application designed for writing, replying to, and downloading love letters.  
Built with **HTML, CSS, and JavaScript**, it blends a soft romantic aesthetic with simple, professional front-end design.
...
- **JavaScript** — interactivity and file handling  
...
Sweet notes for friends

Digital keepsakes

Creative writing and fun projects
